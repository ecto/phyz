...
//!
//! `tau-compile` provides a domain-specific IR for physics computations and
...
//!
//! ```
//! use tau_compile::{KernelBuilder, StencilBuilder, PhysicsOp, Compiler};
//!
...
//!
//! ```
//! use tau_compile::{KernelBuilder, PhysicsOp, FusionOptimizer};
//!
...
//!
//! ```
//! use tau_compile::{KernelBuilder, PhysicsOp, AutoDiff};
//!
